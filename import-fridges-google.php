...
echo "╔══════════════════════════════════════════════════════════╗\n";
echo "║   IMPORT GOOGLE IMAGES - FRIGIDERE                       ║\n";
echo "╚══════════════════════════════════════════════════════════╝\n\n";

$service = new GoogleImageService();

// Găsește toate frigiderele (product_type_id = 6)
$fridges = Product::where('product_type_id', 6)
    ->orderBy('id')
    ->get();
...
foreach ($fridges as $index => $product) {
    $num = $index + 1;
    echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n";
    echo "[$num/" . count($fridges) . "] {$product->name}\n";
...
echo "✅ Succese:  $success / " . count($fridges) . "\n";
echo "❌ Eșecuri:  $failed / " . count($fridges) . "\n";
echo "⚠️  Sărite:   $skipped / " . count($fridges) . "\n\n";
...
$successRate = count($fridges) > 0 ? round(($success / count($fridges)) * 100, 1) : 0;
...
if ($success > 0) {
    ...
    echo "   1. Deschide http://localhost:8080/categorii/frigider\n";
